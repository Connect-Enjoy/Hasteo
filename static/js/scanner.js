...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function onDetected(result) {
        ...
        // Validate and clean student ID in one step
        const studentID = validateAndCleanStudentID(rawCode);
    ...
    // Combined validation and cleaning function
    function validateAndCleanStudentID(code) {
        ...
        return pattern.test(cleanCode) ? cleanCode : null;
    }
